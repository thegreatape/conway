...
(function() {
  ...
  Board = (function() {
    function Board(el, socket) {
      ...
      $('body').on('keydown', (function(_this) {
        return function(evt) {
          ...
          return $(_this.el).addClass('selecting');
        };
      })(this));
      $('body').on('keyup', (function(_this) {
        return function(evt) {
          ...
          $(_this.el).removeClass('selecting');
          return _this.activateSelected();
        };
      })(this));
      $(el).on('mousedown', 'td', (function(_this) {
        return function(evt) {
          return _this.cellClicked(evt);
        };
      })(this));
      $('body').on('mouseup', 'td', (function(_this) {
        return function(evt) {
          return _this.mousedown = false;
        };
      })(this));
      $('body').on('mousedown', 'td', (function(_this) {
        return function(evt) {
          return _this.mousedown = true;
        };
      })(this));
      $(el).on('mouseover', 'td', (function(_this) {
        return function(evt) {
          if (!_this.mousedown) {
            return;
          }
      ...
      socket.connect();
      socket.join("board:state", {}).receive("ok", (function(_this) {
        return function(chan) {
          _this.chan = chan;
          return chan.on("update", function(payload) {
    ...
    Board.prototype.activateSelected = function() {
      var _, coords, ref, x, y, ys;
      coords = [];
      ...
      this.chan.push("activate_cells", coords);
      console.log(coords);
      this.selected = {};
      return $('td.selected').removeClass('selected').addClass('live');
    };

    Board.prototype.cellClicked = function(evt) {
      var base, cell, cellData, x, y;
      if (!this.selecting) {
        return;
      }
      cell = $(evt.target);
      ...
      (base = this.selected)[x] || (base[x] = {});
      this.selected[x][y] = true;
      return cell.addClass('selected');
    };

    Board.prototype.create = function() {
      var boardHtml, i, j, ref, ref1, x, y;
      boardHtml = "";
    ...
    Board.prototype.update = function(data) {
      ...
      for (y = i = 0, ref = this.height - 1; 0 <= ref ? i <= ref : i >= ref; y = 0 <= ref ? ++i : --i) {
        results.push((function() {
          ...
          results1 = [];
          for (x = j = 0, ref1 = this.width - 1; 0 <= ref1 ? j <= ref1 : j >= ref1; x = 0 <= ref1 ? ++j : --j) {
            cell = $(this.el).find("td#x" + x + "-y" + y);
            if (data.cells[y * this.height + x]) {
              cell.addClass("live");
            }
            if ((ref2 = this.selected[x]) != null ? ref2[y] : void 0) {
              results1.push(cell.addClass("selected"));
            } else {
  ...
  $(function() {
    ...
    return board = new Board($('.board'), socket);
  });
